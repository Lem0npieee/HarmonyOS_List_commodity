...
export default class PendingReviewPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(66:5)", "entry");
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(67:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(68:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(69:11)", "entry");
            Image.width(24);
            Image.height(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('待评价');
            Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(74:11)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(78:11)", "entry");
        }, Blank);
        Blank.pop();
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.pendingItems.length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(86:11)", "entry");
                        Column.width(LAYOUT_WIDTH_OR_HEIGHT);
                        Column.height('80%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(87:13)", "entry");
                        Image.width(80);
                        Image.height(80);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(91:13)", "entry");
                        Text.fontSize(14);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        List.create({ space: 0 });
                        List.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(100:11)", "entry");
                        ...
                        const forEachItemGenFunction = (_item, index?: number) => {
                            const product = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(102:15)", "entry");
                                };
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    itemCreation(elmtId, isInitialRender);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Column.create();
                                        Column.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(103:17)", "entry");
                                    }, Column);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create({ space: 8 });
                                        Row.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(104:19)", "entry");
                                        Row.width(LAYOUT_WIDTH_OR_HEIGHT);
                                        Row.alignItems(VerticalAlign.Center);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Image.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(105:21)", "entry");
                                        Image.width(112);
                                        Image.height(112);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Column.create();
                                        Column.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(112:21)", "entry");
                                        Column.alignItems(HorizontalAlign.Start);
                                        Column.layoutWeight(1);
                                    }, Column);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(product.title);
                                        Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(113:23)", "entry");
                                        Text.fontSize(16);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(121:23)", "entry");
                                        Text.fontSize(18);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create('状态：待评价');
                                        Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(125:23)", "entry");
                                        Text.fontSize(12);
                                        Text.fontColor({ "id": 16777288, "type": 10001, params: [], "bundleName": "com.example.list_harmony", "moduleName": "entry" });
                                    }, Text);
                                    Text.pop();
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Button.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(132:21)", "entry");
                                        Button.fontSize(13);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Divider.create();
                                        Divider.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(145:19)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.showEditor && this.editingGoods) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(165:9)", "entry");
                        Column.width('100%');
                        Column.height('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(171:9)", "entry");
                        Column.width('90%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('撰写评价');
                        Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(172:11)", "entry");
                        Text.fontSize(18);
                        Text.fontWeight(FontWeight.Bold);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 12 });
                        Row.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(177:11)", "entry");
                        Row.width('100%');
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create(this.editingGoods.cover);
                        Image.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(178:13)", "entry");
                        Image.width(64);
                        Image.height(64);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(183:13)", "entry");
                        Column.alignItems(HorizontalAlign.Start);
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(this.editingGoods.title);
                        Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(184:15)", "entry");
                        Text.fontSize(15);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(189:15)", "entry");
                        Text.fontSize(12);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 8 });
                        Row.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(198:11)", "entry");
                        Row.margin({ top: 16 });
                        Row.alignItems(VerticalAlign.Center);
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('评分:');
                        Text.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(199:13)", "entry");
                        Text.fontSize(14);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            const star = _item;
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Image.create(star <= this.currentRating ? { "id": 16777353, "type": 20000, params: [], "bundleName": "com.example.list_harmony", "moduleName": "entry" } : { "id": 16777351, "type": 20000, params: [], "bundleName": "com.example.list_harmony", "moduleName": "entry" });
                                Image.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(203:15)", "entry");
                                Image.width(24);
                                Image.height(24);
                                Image.onClick(() => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        TextArea.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(214:11)", "entry");
                        TextArea.width('100%');
                        TextArea.height(140);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 12 });
                        Row.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(226:11)", "entry");
                        Row.width('100%');
                        Row.margin({ top: 20 });
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithLabel('取消');
                        Button.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(227:13)", "entry");
                        Button.fontSize(14);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/PendingReviewPage.ets(236:13)", "entry");
                        Button.fontSize(14);
                        Button.fontColor(Color.White);
                        Button.backgroundColor('#FF6600');
                        Button.borderRadius(20);
