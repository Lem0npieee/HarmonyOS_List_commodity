...
export default class CustomerServicePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(232:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 顶部导航
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(234:7)", "entry");
            // 顶部导航
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(235:9)", "entry");
            Image.width(24);
            Image.height(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(240:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('客服');
            Text.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(241:9)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(244:9)", "entry");
        }, Blank);
        Blank.pop();
        // 顶部导航
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Scroll.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(252:7)", "entry");
            // 聊天列表
            Scroll.layoutWeight(1);
        }, Scroll);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 8 });
            Column.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(253:9)", "entry");
            Column.width(LAYOUT_WIDTH_OR_HEIGHT);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, idx?: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(255:13)", "entry");
                    Row.width(LAYOUT_WIDTH_OR_HEIGHT);
                    ...
                    if (msg.sender === 'ai') {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Image.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(258:17)", "entry");
                                // AI 在左：头像 + 气泡
                                Image.width(36);
                                // AI 在左：头像 + 气泡
                                Image.height(36);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(265:17)", "entry");
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(266:19)", "entry");
                                Text.fontSize(14);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Blank.create();
                                Blank.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(278:17)", "entry");
                            }, Blank);
                            Blank.pop();
                        });
                    }
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Blank.create();
                                Blank.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(280:17)", "entry");
                            }, Blank);
                            Blank.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(282:17)", "entry");
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(msg.text);
                                Text.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(283:19)", "entry");
                                Text.fontSize(14);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Image.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(295:17)", "entry");
                                Image.width(36);
                                Image.height(36);
                                Image.borderRadius(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 输入栏
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(313:7)", "entry");
            // 输入栏
            Row.width(LAYOUT_WIDTH_OR_HEIGHT);
            // 输入栏
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Search.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(314:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/CustomerServicePage.ets(321:9)", "entry");
            Button.fontSize(14);
