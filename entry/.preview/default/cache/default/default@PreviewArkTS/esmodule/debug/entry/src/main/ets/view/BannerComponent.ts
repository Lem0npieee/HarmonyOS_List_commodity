...
export default class BannerComponent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Swiper.debugLine("entry/src/main/ets/view/BannerComponent.ets(29:5)", "entry");
    ...
    private bannerSlide(image: Resource, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/view/BannerComponent.ets(44:5)", "entry");
            Stack.width(commonConst.LAYOUT_WIDTH_OR_HEIGHT);
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create(image);
            Image.debugLine("entry/src/main/ets/view/BannerComponent.ets(45:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/view/BannerComponent.ets(50:7)", "entry");
            Column.padding(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/BannerComponent.ets(51:9)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/view/BannerComponent.ets(56:9)", "entry");
