...
export default class ConfirmReceiptPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(40:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 顶部导航
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(42:7)", "entry");
            // 顶部导航
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(43:9)", "entry");
            Image.width(24);
            Image.height(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('确认收货');
            Text.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(48:9)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(52:9)", "entry");
        }, Blank);
        Blank.pop();
        // 顶部导航
        Row.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.pendingItems.length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(60:9)", "entry");
                        Column.width(LAYOUT_WIDTH_OR_HEIGHT);
                        Column.height('80%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(61:11)", "entry");
                        Image.width(80);
                        Image.height(80);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(65:11)", "entry");
                        Text.fontSize(14);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        List.create({ space: 0 });
                        List.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(74:9)", "entry");
                        ...
                        const forEachItemGenFunction = (_item, index?: number) => {
                            const product = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ...
                                    ListItem.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(76:13)", "entry");
                                };
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    itemCreation(elmtId, isInitialRender);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Column.create();
                                        Column.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(77:15)", "entry");
                                    }, Column);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create({ space: 8 });
                                        Row.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(78:17)", "entry");
                                        Row.width(LAYOUT_WIDTH_OR_HEIGHT);
                                        Row.alignItems(VerticalAlign.Center);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Image.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(79:19)", "entry");
                                        Image.width(112);
                                        Image.height(112);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Column.create();
                                        Column.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(86:19)", "entry");
                                        Column.alignItems(HorizontalAlign.Start);
                                        Column.layoutWeight(1);
                                    }, Column);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(product.title);
                                        Text.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(87:21)", "entry");
                                        Text.fontSize(16);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(95:21)", "entry");
                                        Text.fontSize(18);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(99:21)", "entry");
                                        Text.fontSize(12);
                                        Text.fontColor({ "id": 16777288, "type": 10001, params: [], "bundleName": "com.example.list_harmony", "moduleName": "entry" });
                                    }, Text);
                                    Text.pop();
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Button.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(106:19)", "entry");
                                        Button.fontSize(13);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Divider.create();
                                        Divider.debugLine("entry/src/main/ets/pages/ConfirmReceiptPage.ets(119:17)", "entry");
